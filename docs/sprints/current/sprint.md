...
- [x] AI visuals comparison baseline: sliders and aging grid use projected AFTER portrait (labeled Potential) instead of original front photo (status: completed)
