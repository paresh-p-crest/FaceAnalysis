...
- [x] Skin page: wrap/shrink projected-image-pending label in narrow frames (status: completed)
- [x] Skin page B/A: zoom out crop ~18–20% around same center (status: completed)
- [x] Neck page: full-width summary bar under columns (status: completed)
- [x] Protocol PDF/HTML ears page — side-by-side B/A; Ohrstruktur mid-split body; full-width summary (status: completed)
- [x] Customer dashboard — web layout (no A4 / no PDF header) (status: completed)
- [x] Customer dashboard — protocol page-1 body + keep Share/PDF top bar (status: completed)
- [x] Customer dashboard — projected pending placeholder + potential age (status: completed)
- [x] Open report — Opening… UI on tap (flushSync; admin no pre-fetch) (status: completed)
- [x] Feature Evaluation prompt — soft structure + natural flow; no missing-detail meta / no semicolons (status: completed)
- [x] Protocol page 1 Merkmalsbewertung — store full bullets; display truncateAtSentences (status: completed)
- [x] Protocol page 1 Merkmalsbewertung — LLM featureHighlights + CV fallback under analysis card (status: completed)
- [x] Protocol page 1 columns — wider center + larger B/A; narrower right (status: completed)
- [x] Protocol page 1 Überblick — content-sized + margin above footer (status: completed)
- [x] Protocol page 1 Überblick — under tallest column, grow to footer (not bottom-pinned) (status: completed)
- [x] Protocol page 1 Harmonieprofil — same 11-axis feature radar as page 5 (client + projected) (status: completed)
- [x] Protocol page 1 name card + centered wordmark logo (page 1 only) (status: completed)
- [x] Protocol page 1 analysis face map — drop skin/cheeks/mouth markers + labels (status: completed)
- [x] Protocol page 1 analysis card — even tabular labels + marker→label lines; steps under photo (status: completed)
- [x] Protocol page 1 dashboard — client 3-col layout; dual age (DB front + AFTER clamp); full-width Überblick (status: completed)
- [x] Protocol PDF/HTML chin page — side-by-side profiles; two-col body under; B/A + summary bar (match design) (status: completed)
- [x] Protocol PDF/HTML jaw page — bottom row flows under B/A (fixed gap, no stickToBottom) (status: completed)
- [x] Protocol PDF/HTML nose page — summary under left body (fixed gap, content-sized; right = profile + B/A) (status: completed)
- [x] Protocol PDF/HTML hair page — side-by-side B/A; Frisur + Haarausfall two-col bodies (match design screenshot) (status: completed)
- [x] Protocol PDF/HTML page 3 introduction — two-col intro/Inhalt + bottom Einschränkungen box (match design screenshot) (status: completed)
- [x] Protocol PDF/HTML page 2 disclaimer — stacked grey box + privacy + company (match design screenshot) (status: completed)
...
- [x] Chin PDF summary bar: section-specific first-sentence keep truncation (`splitTextAtSentencesKeepFirst`) with small controlled bottom overflow (status: completed)
- [x] Restore 3 executive hero bullets on page 1 (`Gemessene Morphologie`, `Projiziertes Potenzial`, `Gestuftes Protokoll`) (status: completed)
