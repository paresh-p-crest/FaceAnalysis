...
- **English is feature-led third person (ADR-049).** Feature as grammatical subject; “the subject’s” only as possessive. Finding → visual significance → supported non-surgical next step or no-change → synthesis. Client German corrections are the DE style authority. Reference is information architecture only, never a treatment-instruction source.
