...
- [Deployment launcher permissions](deployment-launcher-permissions.md) — production shell launchers must be executable or VM publishing fails after a successful build
