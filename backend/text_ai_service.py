...
STRICT_NON_SURGICAL_RULES = (
    ...
    "- NEVER mention or recommend any invasive or energy-based treatment, including: surgery, "
    "injectables, fillers, Botox, lasers, IPL, HIFU, Thermage, Endolift, microneedling, chemical peels, "
    "radiofrequency, Ultherapy, energy-based devices, prescriptions, clinical procedures, weight-loss "
    "drugs, or in-clinic treatments.\n"
